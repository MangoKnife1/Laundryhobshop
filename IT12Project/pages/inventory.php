...
<main class="main-container">
    <div class="right">
        <a href="#addInventoryModal" class="modal-button">+ ADD STAFF</a>
    </div>
    ...
    <div id="addInventoryModal" class="modal">
        <div class="modal-content">
            ...
            <form action="../repositories/add_inventory_repositories.php" method="POST">
                <div class="form-group">
                    <label for="first_name">product_name</label>
